;(function () {
	...
	var offcanvasMenu = function() {
		...
		$('#page').prepend('<a href="#" class="js-gtco-nav-toggle gtco-nav-toggle sticky"><i></i></a>');
		...
		$('#gtco-offcanvas ul li a').click(function(){
			var $this = $(this);
